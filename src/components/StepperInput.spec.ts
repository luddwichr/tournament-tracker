...
describe('StepperInput', () => {
  it('renders the current value', () => {
    const wrapper = mount(StepperInput, {
      props: { decLabel: 'dec', incLabel: 'inc', modelValue: 3 },
    })
  ...
  it('increment button emits updated value', async () => {
    const wrapper = mount(StepperInput, {
      props: { decLabel: 'dec', incLabel: 'inc', modelValue: 2 },
    })
  ...
  it('does not go below 0', async () => {
    const wrapper = mount(StepperInput, {
      props: { decLabel: 'dec', incLabel: 'inc', modelValue: 0 },
    })
    await wrapper.findAll('button')[0]!.trigger('click')
  ...
  it('enables the decrement button once the value is above 0', () => {
    const wrapper = mount(StepperInput, {
      props: { decLabel: 'dec', incLabel: 'inc', modelValue: 1 },
    })
    const [dec] = wrapper.findAll('button')
  ...
  it('uses provided aria-labels on buttons', () => {
    const wrapper = mount(StepperInput, {
      props: { decLabel: 'Verringern', incLabel: 'Erhöhen', modelValue: 0 },
    })
  ...
  it('applies stepper--lg class when size="lg"', () => {
    const wrapper = mount(StepperInput, {
      props: { decLabel: 'dec', incLabel: 'inc', modelValue: 0, size: 'lg' },
    })
